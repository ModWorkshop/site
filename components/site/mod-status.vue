<template>
    <span>
        ...
        <font-awesome-icon v-else-if="mod.approved === false" icon="circle-xmark" class="text-danger" :title="statusText"/>
        <font-awesome-icon v-else-if="mod.approved === null" icon="clock" class="text-secondary" :title="statusText"/>
