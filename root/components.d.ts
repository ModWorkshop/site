...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    'IIc:outlineKeyboardArrowDown': typeof import('~icons/ic/outline-keyboard-arrow-down')['default']
    IIcOutlineKeyboardArrowDown: typeof import('~icons/ic/outline-keyboard-arrow-down')['default']
