...
(function(d, x) {
    var xhr = new x();
    var url = "https://api.enthusiastgaming.net/scripts/cdn.enthusiast.gg/script/eg-aps/production/eg-aps-bootstrap.bundle.js?site=modworkshop.net";
    ...
    xhr.send(null);
})(document, XMLHttpRequest, 'modworkshop.net');`
        }
    ]
});
</script>
