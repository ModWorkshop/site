...
class UserResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'game_role_ids' => $this->when(isset($this->currentGameId), fn() => Arr::pluck($this->gameRoles, 'id')),
            'game_highest_role_order' => $this->when(isset($this->currentGameId), fn() => $this->getGameHighestOrder($this->currentGameId)),
