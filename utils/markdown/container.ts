...
// Taken from https://github.com/markdown-it/markdown-it-container/blob/master/index.mjs and modified slightly
// 1. Remove validation to allow for stuff like :::\ntest\n:::
// 2. Allowing min_markers to be changed
//
export default function container_plugin (md, name, options) {
    // Second param may be useful if you decide
    // to increase minimal allowed marker length
    function validateDefault (params/*, markup */) {
      return true//params.trim().split(' ', 2)[0] === name
    }
