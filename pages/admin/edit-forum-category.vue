            ...
            <a-table>
                ...
                <tbody>
                    <tr v-for="addedRole in addedRoles" :key="addedRole.id">
                        ...
                        <td><a-button color="danger" icon="trash" @click="removeRolePolicy(addedRole.id)">{{$t('delete')}}</a-button></td>
                    </tr>
                </tbody>
            </a-table>
        </flex>
            ...
            <a-table>
                ...
                <tbody>
                    <tr v-for="addedRole in addedGameRoles" :key="addedRole.id">
                        ...
                        <td><a-input v-model="addedRole.policy.can_view" type="checkbox"/></td>
                        <td><a-input v-model="addedRole.policy.can_post" type="checkbox"/></td>
                        <td><a-button color="danger" icon="trash" @click="removeGameRolePolicy(addedRole.id)">{{$t('delete')}}</a-button></td>
                    </tr>
                </tbody>
            </a-table>
        </flex>
