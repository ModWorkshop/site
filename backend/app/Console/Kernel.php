...
use App\Jobs\ScanSomeFilesArchivePaths;
...
class Kernel extends ConsoleKernel
{
    ...
    {
        $schedule->job(new CalculatePopularity)->everyFifteenMinutes();
        ...
        $schedule->job(new ScanSomeFilesArchivePaths)->everyThirtyMinutes();
