...
class ModResource extends BaseResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'files_are_versions' => $this->files_are_versions,
            ...
            'download_version' => $this->whenAppended('download_version'),
            'mod_managers' => $this->whenAppended('mod_managers'),
            'banner' => $this->bannerAttribute,
            'thumbnail' => $this->thumbnailAttribute,
            ...
            'files' => $this->whenLoaded('files', fn() => new LightCollection($this->withSecureConstraints(fn() => $this->files()->paginate(5)))),
            'links' => $this->whenLoaded('links', fn() => new LightCollection($this->withSecureConstraints(fn() => $this->links()->paginate(5)))),
            'files_count' => $this->when($this->fullLoad, fn() => $this->files_count),
            'links_count' => $this->when($this->fullLoad, fn() => $this->links_count),
            ...
            'used_storage' => $this->whenAggregated('files', 'size', 'sum', fn($val) => intval($val)),
