...
')
     ...
     */ 
         ...
         * @see \BiiiiiigMonster\Hasin\Database\Eloquent\RelationMixin::getRelationInQuery()
         * @static 
         */ 
        public static function getRelationInQuery($query, $parentQuery, $columns = [])
        {
                        return \Illuminate\Database\Eloquent\Relations\Relation::getRelationInQuery($query, $parentQuery, $columns);
        }
                    /**
         * 
         *
...
namespace  { 
             ...
             * @static 
             */ 
            public static function hasByJoin(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::hasByJoin(...$args);
            }
             ...
             * @static 
             */ 
            public static function hasByNonDependentSubquery(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::hasByNonDependentSubquery(...$args);
            }
             ...
             * @static 
             */ 
            public static function orHasByNonDependentSubquery(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::orHasByNonDependentSubquery(...$args);
            }
             ...
             * @static 
             */ 
            public static function doesntHaveByNonDependentSubquery(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::doesntHaveByNonDependentSubquery(...$args);
            }
             ...
             * @static 
             */ 
            public static function orDoesntHaveByNonDependentSubquery(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::orDoesntHaveByNonDependentSubquery(...$args);
            }
